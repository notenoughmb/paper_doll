...
# im really sick of making first person controllers every time i try to make a 3d game soo
...
@export var LIGHTER : Lighter
@export var HORROR_MANAGER : HorrorManager
